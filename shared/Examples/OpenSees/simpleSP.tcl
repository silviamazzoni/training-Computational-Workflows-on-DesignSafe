# mpiexec -np 4 OpenSeesSP simpleSP.tcl
...
# ----------------------------
set dataDir DataTCLsp;                # set up name of data directory
file mkdir $dataDir; # create data directory

recorder Node -file  $dataDir/Node.out -time -node $nn -dof 1 disp
...
recorder Element -file $dataDir/ele.out -eleRange 1 10 material 1 strains
